...
function [t_make_ham, t_all_blks, block_timing_eig, block_timing_evol, t_meas] = ED_evolve_block_diag_serial(NN, M, XXZCoeff, Jmat, init_state)
...
%% Sanity check: traces of both density matrices have to always be one
%Rho_i = psi_i*psi_i';
