...
function ED_evolve_block_diag_gpu_parfeval_lb(NN, M, XXZCoeff, Jmat, init_state)
...
% Use custom load-balancing for eigens of matrices
...
for k = 1:length(eigvec_cell)
    ...
    %convert the state back to original basis and normalize
    f = parfeval(fevalMult,1,eigvec_cell{k},psiEig_f_times_blk);
